...
## Balance Band has moved (2026-09-23)

The balance / posturography work that was briefly in `balance_band/` is now its own project:
**`sudhirkots/balance-angular-posturography`** (with its full history). It has nothing to do with this repo.
